...
def deserialize_model_wrapper(file):
    #print(">>> ml > modelwraper.py > None : deserialize_model_wrapper()")

    return dill.load(file)


def get_pickle_file_name(mdl, runtime_config):
    #print(">>> ml > modelwraper.py > None : get_pickle_file_name()")
...
class SimpleModelWrapper:
    def __init__(self, mdl, tbl, x, y=None, n_total_point=1.0, n_sample_point=1.0, x_min_value=-np.inf, x_max_value=np.inf, groupby_attribute=None, groupby_value=None):
        #print(">>> ml > modelwraper.py > SimpleModelWrapper : __init__()")
        self.mdl = mdl
        self.tbl = tbl
        self.x = x
        self.y = y
    ...
    def load_model(self, density, reg=None):
        #print(">>> ml > modelwraper.py > SimpleModelWrapper : load_model()")

        self.reg = reg
        self.density = density

    def init_pickle_file_name(self, runtime_config):
        #print(">>> ml > modelwraper.py > SimpleModelWrapper : init_pickle_file_name()")
    ...
    def serialize(self):
        #print(">>> ml > modelwraper.py > SimpleModelWrapper : serialize()")

        return dill.dumps(self)

    def serialize2warehouse(self, warehouse, runtime_config):
        #print(">>> ml > modelwraper.py > SimpleModelWrapper : serialize2warehouse()")
...
class GroupByModelWrapper:
    def __init__(self, mdl, tbl, x, y, groupby_attribute,  x_min_value=-np.inf, x_max_value=np.inf):
        #print(">>> ml > modelwraper.py > GroupByModelWrapper : __init__()")
    ...
    def add_simple_model(self, simple_model):
        #print(">>> ml > modelwraper.py > GroupByModelWrapper : add_simple_model()")
    ...
    def serialize2warehouse(self, warehouse):
        #print(">>> ml > modelwraper.py > GroupByModelWrapper : serialize2warehouse()")
...
class KdeModelWrapper:
    def __init__(self, mdl, tbl, x, y=None, n_total_point={}, x_min_value=-np.inf, x_max_value=np.inf, groupby_attribute=None, groupby_values={}):
        #print(">>> ml > modelwraper.py > KdeModelWrapper : __init__()")
    ...
    def load_model(self, mdl_name, density, reg=None):
        #print(">>> ml > modelwraper.py > KdeModelWrapper : load_model()")
    ...
    def init_pickle_file_name(self, runtime_config):
        #print(">>> ml > modelwraper.py > KdeModelWrapper : init_pickle_file_name()")
    ...
    def serialize(self):
        #print(">>> ml > modelwraper.py > KdeModelWrapper : serialize()")

        return dill.dumps(self)

    def serialize2warehouse(self, warehouse, runtime_config):
        #print(">>> ml > modelwraper.py > KdeModelWrapper : serialize2warehouse()")
...
if __name__ == "__main__":
    #print(">>> ml > modelwraper.py > None : __main__()")

...
def query(sqlExecutor):
    ...
    #                     result2file="/home/u1796377/Projects/ETRIMLClient/experiments/results/mdn501/ss1t_gg32_cpu.txt", n_jobs=1)


def query_workload(sqlExecutor, model_name, n_jobs):
    sqlExecutor.execute("set n_jobs=" + str(n_jobs) + '"')
    sqlExecutor.execute(
        "set result2file='/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn501/sum1.txt'"
    )
    sqlExecutor.execute(
    ...
    sqlExecutor.execute(
        "set result2file='/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn501/sum2.txt'"
    )
    sqlExecutor.execute(
        "select sum(ss_sales_price)   from "
        + model_name
    ...
    sqlExecutor.execute(
        "set result2file='/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn501/sum3.txt'"
    )
    sqlExecutor.execute(
        "select sum(ss_sales_price)   from "
        + model_name
    ...
    sqlExecutor.execute(
        "set result2file='/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn501/sum4.txt'"
    )
    sqlExecutor.execute(
        "select sum(ss_sales_price)   from "
        + model_name
    ...
    sqlExecutor.execute(
        "set result2file='/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn501/sum5.txt'"
    )
    sqlExecutor.execute(
        "select sum(ss_sales_price)   from "
        + model_name
    ...
    sqlExecutor.execute(
        "set result2file='/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn501/sum6.txt'"
    )
    sqlExecutor.execute(
        "select sum(ss_sales_price)   from "
        + model_name
    ...
    sqlExecutor.execute(
        "set result2file='/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn501/sum7.txt'"
    )
    sqlExecutor.execute(
        "select sum(ss_sales_price)   from "
        + model_name
    ...
    sqlExecutor.execute(
        "set result2file='/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn501/sum8.txt'"
    )
    sqlExecutor.execute(
        "select sum(ss_sales_price)   from "
        + model_name
    ...
    sqlExecutor.execute(
        "set result2file='/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn501/sum9.txt'"
    )
    sqlExecutor.execute(
        "select sum(ss_sales_price)   from "
        + model_name
    ...
    sqlExecutor.execute(
        "set result2file='/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn501/sum10.txt'"
    )
    sqlExecutor.execute(
        "select sum(ss_sales_price)   from "
        + model_name
    ...
    sqlExecutor.execute(
        "set result2file='/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn501/count1.txt'"
    )
    sqlExecutor.execute(
    ...
    sqlExecutor.execute(
        "set result2file='/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn501/count2.txt'"
    )
    sqlExecutor.execute(
        "select count(ss_sales_price) from "
        + model_name
    ...
    sqlExecutor.execute(
        "set result2file='/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn501/count3.txt'"
    )
    sqlExecutor.execute(
        "select count(ss_sales_price) from "
        + model_name
    ...
    sqlExecutor.execute(
        "set result2file='/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn501/count4.txt'"
    )
    sqlExecutor.execute(
        "select count(ss_sales_price) from "
        + model_name
    ...
    sqlExecutor.execute(
        "set result2file='/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn501/count5.txt'"
    )
    sqlExecutor.execute(
        "select count(ss_sales_price) from "
        + model_name
    ...
    sqlExecutor.execute(
        "set result2file='/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn501/count6.txt'"
    )
    sqlExecutor.execute(
        "select count(ss_sales_price) from "
        + model_name
    ...
    sqlExecutor.execute(
        "set result2file='/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn501/count7.txt'"
    )
    sqlExecutor.execute(
        "select count(ss_sales_price) from "
        + model_name
    ...
    sqlExecutor.execute(
        "set result2file='/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn501/count8.txt'"
    )
    sqlExecutor.execute(
        "select count(ss_sales_price) from "
        + model_name
    ...
    sqlExecutor.execute(
        "set result2file='/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn501/count9.txt'"
    )
    sqlExecutor.execute(
        "select count(ss_sales_price) from "
        + model_name
    ...
    sqlExecutor.execute(
        "set result2file='/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn501/count10.txt'"
    )
    sqlExecutor.execute(
        "select count(ss_sales_price) from "
        + model_name
    ...
    sqlExecutor.execute(
        "set result2file='/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn501/avg1.txt'"
    )
    sqlExecutor.execute(
    ...
    sqlExecutor.execute(
        "set result2file='/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn501/avg2.txt'"
    )
    sqlExecutor.execute(
        "select avg(ss_sales_price)   from "
        + model_name
    ...
    sqlExecutor.execute(
        "set result2file='/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn501/avg3.txt'"
    )
    sqlExecutor.execute(
        "select avg(ss_sales_price)   from "
        + model_name
    ...
    sqlExecutor.execute(
        "set result2file='/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn501/avg4.txt'"
    )
    sqlExecutor.execute(
        "select avg(ss_sales_price)   from "
        + model_name
    ...
    sqlExecutor.execute(
        "set result2file='/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn501/avg5.txt'"
    )
    sqlExecutor.execute(
        "select avg(ss_sales_price)   from "
        + model_name
    ...
    sqlExecutor.execute(
        "set result2file='/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn501/avg6.txt'"
    )
    sqlExecutor.execute(
        "select avg(ss_sales_price)   from "
        + model_name
    ...
    sqlExecutor.execute(
        "set result2file='/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn501/avg7.txt'"
    )
    sqlExecutor.execute(
        "select avg(ss_sales_price)   from "
        + model_name
    ...
    sqlExecutor.execute(
        "set result2file='/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn501/avg8.txt'"
    )
    sqlExecutor.execute(
        "select avg(ss_sales_price)   from "
        + model_name
    ...
    sqlExecutor.execute(
        "set result2file='/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn501/avg9.txt'"
    )
    sqlExecutor.execute(
        "select avg(ss_sales_price)   from "
        + model_name
    ...
    sqlExecutor.execute(
        "set result2file='/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn501/avg10.txt'"
    )
    sqlExecutor.execute(
        "select avg(ss_sales_price)   from "
        + model_name

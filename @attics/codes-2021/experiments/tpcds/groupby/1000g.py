...
class Query1:
    ...
    def build_model(self, mdl_name: str = "ss_1t", encoder='binary'):
    ...
    def workload(self, mdl_name, result2file: str = '/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn/1t/', n_jobs=1):
...
if __name__ == "__main__":
    ...
    query1.build_model(
        mdl_name="ss_1t_25m_embedding_epoch30_node_3030_gaussian_1530_embedding_30", encoder="embedding")
    query1.workload("ss_1t_25m_embedding_epoch40_node_4040_gaussian_88_embedding_40",
                    result2file="experiments/results/mdn/1t/", n_jobs=1)

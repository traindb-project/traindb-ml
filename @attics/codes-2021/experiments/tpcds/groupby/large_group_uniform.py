...
class Query1:
    ...
    def build_model2_5m(self, mdl_name: str = "ss_gb2_2_5", encoder='embedding'):
        ...
        self.sql_executor.execute(
            "create table "+mdl_name+"(ss_sales_price real, ss_sold_date_sk real) from '/home/quincy/Documents/workspace/data/tpcds/1t/ss_2_5m.csv' GROUP BY ss_store_sk,ss_quantity method uniform size 0.1' ")  # num_of_points57.csv
    ...
    def build_model5_2m(self, mdl_name: str = "ss_gb2_5_2", encoder='embedding'):
        ...
        self.sql_executor.execute(
            "create table "+mdl_name+"(ss_sales_price real, ss_sold_date_sk real) from '/home/quincy/Documents/workspace/data/tpcds/1t/ss_5m.csv' GROUP BY ss_store_sk,ss_quantity method uniform size 0.1' ")  # num_of_points57.csv
    ...
    def build_model_10m(self, mdl_name: str = "ss_gb2_5_2", encoder='embedding'):
        ...
        self.sql_executor.execute(
            "create table "+mdl_name+"(ss_sales_price real, ss_sold_date_sk real) from '/home/quincy/Documents/workspace/data/tpcds/1t/ss_10m.csv' GROUP BY ss_store_sk,ss_quantity method uniform size 0.1' ")  # num_of_points57.csv
    ...
    def query_workload(self, mdl_name, result2file: str = '/home/u1796377/Documents/workspace/ETRIMLClient/experiments/results/mdn/10g/', n_jobs=1):
        self.sql_executor.execute(
...
if  __name__ == "__main__":
    q1= Query1()
    q1.build_model2_5m("ss_gb2_2_5_uniform")
    # q1.mdl_name="ss_gb2_2_5_uniform"
    # q1.query_workload("ss_gb2_2_5_uniform",result2file="experiments/results/mdn/1t2cols/2_5g/")

    q1.build_model5_2m("ss_gb2_5_2_uniform")
    q1.mdl_name="ss_gb2_5_2_uniform"
    # q1.query_workload("ss_gb2_5_2_uniform",result2file="experiments/results/mdn/1t2cols/5g/")

    q1.build_model_10m("ss_gb2_10_uniform")
    q1.mdl_name="ss_gb2_10_uniform"
    # q1.query_workload("ss_gb2_10_uniform",result2file="experiments/results/mdn/1t2cols/10g/")

    q1.build_model_10m("ss_1t_20m_embedding_epoch30_node_3030_gaussian_1530_embedding_20_newversion2_10m")
    # q1.mdl_name="ss_1t_20m_embedding_epoch30_node_3030_gaussian_1530_embedding_20_newversion2_10m"
    # q1.query_workload("ss_1t_20m_embedding_epoch30_node_3030_gaussian_1530_embedding_20_newversion2_10m",result2file="experiments/results/mdn/1t2cols/10g_mehrdad/")


    q1.build_model_10m("ss_1t_20m_embedding_epoch30_node_3030_gaussian_1530_embedding_20_newversion2_20m")
    q1.mdl_name="ss_1t_20m_embedding_epoch30_node_3030_gaussian_1530_embedding_20_newversion2_20m"
    q1.query_workload("ss_1t_20m_embedding_epoch30_node_3030_gaussian_1530_embedding_20_newversion2_20m",result2file="experiments/results/mdn/1t2cols/20g/")
    # ss_1t_20m_embedding_epoch30_node_3030_gaussian_1530_embedding_20_newversion2_20m
    ...
    # q1.build_model_10m("ss_2_5_uniform")

...
def plt_workload(agg_func="avg", suffix="_ss1t_gg4.txt", b_plot=True, b_merge_result_for_group=False, b_two_methods=False):
    ...
    for i in range(1, 11):
        ...
        #                    prefix+suffix)
        mdn = read_results("experiments/results/ETRIML/1t2cols/5g/" +
...
if __name__ == "__main__":
    ...
    plt_workload(agg_func="count", suffix=".txt", b_plot=True,
                 b_merge_result_for_group=False, b_two_methods=False)
    plt_workload(agg_func="sum", suffix=".txt", b_plot=True,
                 b_merge_result_for_group=False, b_two_methods=False)
    plt_workload(agg_func="avg", suffix=".txt", b_plot=True,
                 b_merge_result_for_group=False, b_two_methods=False)

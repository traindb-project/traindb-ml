...
from etrimlclient.ml.embedding import WordEmbedding, columns2sentences
from etrimlclient.ml.integral import approx_count, prepare_reg_density_data
from etrimlclient.ml.wordembedding import SkipGram
...
def gaussian_probability(sigma, mu, data):
    #print(">>> ml > mdn.py > MDN : gaussian_probability()")
...
def gaussion_predict(weights: list, mus: list, sigmas: list, xs: list, n_jobs=1):
    #print(">>> ml > mdn.py > MDN : gaussion_predict()")
...
class GenericMdn:
    def __init__(self, config):
        #print(">>> ml > mdn.py > GenericMdn : __init__()")
...
class RegMdnGroupBy:
    ...
    def __init__(self, config, b_normalize_data=True):
        #print(">>> ml > mdn.py > RegMdnGroupBy : denormalize()")
    ...
    def fit_grid_search(
        ...
        #print(">>> ml > mdn.py > RegMdnGroupBy : fit_grid_search()")
    ...
    def predict(
        ...
        #print(">>> ml > mdn.py > RegMdnGroupBy : predict()")
    ...
    def score(self, runtime_config) -> float:
        #print(">>> ml > mdn.py > RegMdnGroupBy : score()")
...
class RegMdn:
    ...
    def __init__(self, config, dim_input, b_store_training_data=False):
        #print(">>> ml > mdn.py > RegMdn : __init__()")
    ...
    def predict(self, xs, runtime_config, b_show_plot=False):
        #print(">>> ml > mdn.py > RegMdn : predict()")
    ...
    def fit3d_grid_search(
        ...
        #print(">>> ml > mdn.py > RegMdn : fit3d_grid_search()")
    ...
    def predict3d(
        ...
        #print(">>> ml > mdn.py > RegMdn : predict3d()")
    ...
    def predict2d(
        ...
        #print(">>> ml > mdn.py > RegMdn : predict2d()")
    ...
    def normalize(self, x, mean, width):
        #print(">>> ml > mdn.py > RegMdn : normalize()")
    ...
    def denormalize(self, x, mean, width):
        #print(">>> ml > mdn.py > RegMdn : denormalize()")
...
class KdeMdn:
    ...
    def __init__(self, config, b_store_training_data=False, b_normalize_data=True):
        #print(">>> ml > mdn.py > KdeMdn : __init__()")
    ...
    def fit_grid_search(self, zs: list, xs: list, runtime_config):  # , b_normalize=True
        #print(">>> ml > mdn.py > KdeMdn : fit_grid_search()")
    ...
    def predict(
        ...
        #print(">>> ml > mdn.py > KdeMdn : predict()")
    ...
    def normalize(self, x: list, mean: float, width: float):
        #print(">>> ml > mdn.py > KdeMdn : normalize()")
    ...
    def denormalize(self, x, mean, width):
        #print(">>> ml > mdn.py > KdeMdn : denormalize()")
    ...
    def plot_density_3d(self, runtime_config, n_division=20):
        #print(">>> ml > mdn.py > KdeMdn : plot_density_3d()")
    ...
    def plot_density_per_group(self, runtime_config, n_division=100):
        #print(">>> ml > mdn.py > KdeMdn : plot_density_per_group()")
    ...
    def serialize(self, file: str):
        #print(">>> ml > mdn.py > KdeMdn : serialize()")
    ...
    def bin_wise_error(self, g, n_division=20, b_show_plot=True):
        #print(">>> ml > mdn.py > KdeMdn : bin_wise_error()")
...
class KdeMdnOneModel(GenericMdn):
    def __init__(self, config, b_store_training_data=False, b_normalize_data=True):
        #print(">>> ml > mdn.py > KdeMdnOneModel : __init__()")
    ...
    def fit(self):
        #print(">>> ml > mdn.py > KdeMdnOneModel : fit()")

        pass

    def fit_grid_search(self):
        #print(">>> ml > mdn.py > KdeMdnOneModel : fit_grid_search()")

        pass

    def score(self):
        #print(">>> ml > mdn.py > KdeMdnOneModel : score()")
...
def test_pm25_2d():
    ...
    file = "/home/u1796377/Programs/etrimlwarehouse/pm25.csv"
    # file = "/home/u1796377/Programs/etrimlwarehouse/pm25_torch_2k.csv"
    df = pd.read_csv(file)
...
def test_pm25_2d_density():
    import pandas as pd
    from etrimlclient.tools.running_parameters import RUNTIME_CONF as runtime_config
    from etrimlclient.tools.running_parameters import EtrimlConfig
    ...
    regMdn = KdeMdn(EtrimlConfig(), b_store_training_data=True)
